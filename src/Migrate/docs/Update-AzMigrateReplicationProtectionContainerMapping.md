...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/update-azmigratereplicationprotectioncontainermapping
schema: 2.0.0
---

# Update-AzMigrateReplicationProtectionContainerMapping
...
```
Update-AzMigrateReplicationProtectionContainerMapping -FabricName <String> -MappingName <String>
...
```
Update-AzMigrateReplicationProtectionContainerMapping -InputObject <IMigrateIdentity>
