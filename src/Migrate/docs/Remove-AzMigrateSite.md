...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/remove-azmigratesite
schema: 2.0.0
---

# Remove-AzMigrateSite
...
### Delete (Default)
```
Remove-AzMigrateSite -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzMigrateSite -InputObject <IMigrateIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
