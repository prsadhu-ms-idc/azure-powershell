...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/invoke-azmigratecleanupsolutiondata
schema: 2.0.0
---

# Invoke-AzMigrateCleanupSolutionData
...
### Cleanup (Default)
```
Invoke-AzMigrateCleanupSolutionData -MigrateProjectName <String> -ResourceGroupName <String>
 -SolutionName <String> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CleanupViaIdentity
```
Invoke-AzMigrateCleanupSolutionData -InputObject <IMigrateIdentity> [-DefaultProfile <PSObject>] [-PassThru]
...
Parameter Sets: CleanupViaIdentity
Aliases:
