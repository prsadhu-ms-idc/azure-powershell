...
online version: https://docs.microsoft.com/en-us/powershell/module/az.migrate/remove-azmigratereplicationprotectioncontainermapping
schema: 2.0.0
---

# Remove-AzMigrateReplicationProtectionContainerMapping
...
```
Remove-AzMigrateReplicationProtectionContainerMapping -FabricName <String> -MappingName <String>
...
### DeleteViaIdentity
```
Remove-AzMigrateReplicationProtectionContainerMapping -InputObject <IMigrateIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api20180110.IRemoveProtectionContainerMappingInput
